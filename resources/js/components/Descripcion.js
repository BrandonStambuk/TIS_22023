...
import '../../../resources/css/Crear.css';
...
function Descripcion() {
    ...
    return (
        <div>
            <h3 className="otro">Descripción</h3>
            <div className="mb-3">
            ...
            <div>
                ...
                ></textarea>
                <button type="submit" className="btn btn-danger btn-lg btn-block  boton-1">Atras</button>
                <button type="submit" className="btn btn-warning btn-lg btn-block mx-auto boton-2">Crear Afiche</button>
                <button type="submit" className="btn btn-primary btn-lg mx-auto boton-3">Registrar</button>
            </div>
        </div>
    );
}
